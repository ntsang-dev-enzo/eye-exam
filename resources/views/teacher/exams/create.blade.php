...
@section('content')
    <div class="max-w-5xl mx-auto pb-12">
        <form id="examForm" action="{{ route('teacher.exams.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8 relative">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" required class="w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5 bg-gray-50 text-sm" placeholder="VD: Giữa kỳ Toán Rời Rạc">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="start_at" class="w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5 bg-gray-50 text-sm">
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Thời gian kết thúc (Tùy chọn)</label>
                        <input type="datetime-local" name="end_at" class="w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 px-4 py-2.5 bg-gray-50 text-sm">
                    </div>
            ...
            <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('teacher.dashboard') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors">
                    Hủy bỏ
                </a>
    ...
    <script>
        // State
        let selectedQuestions = []; // Array of objects {id, content, type, point}
        let bankQuestions = [];
