                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    @forelse($classes as $class)
                        <tr class="hover:bg-slate-50/75 transition-colors">
                            ...
                            <!-- Subject Assignments -->
                            <td class="py-3 px-4 text-center whitespace-nowrap">
                                <a href="{{ route('admin.classes.show', $class) }}" class="inline-flex items-center gap-1 px-2.5 py-1 rounded text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200 hover:bg-blue-100 transition-colors" title="Phân công giảng viên giảng dạy">
