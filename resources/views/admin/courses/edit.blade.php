...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-xl font-bold text-slate-900 tracking-tight">Chỉnh Sửa Khóa Học</h1>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3" placeholder="Nhập mô tả ngắn gọn..." 
                        class="w-full p-3 bg-white border border-slate-200 rounded-md text-sm font-medium text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-colors">{{ old('description', $course->description) }}</textarea>
                </div>
        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6 space-y-4"
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-3 gap-2">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Chỉnh sửa danh sách các môn học thuộc khóa học này</p>
                </div>
